...
function verifyInternalPageRoutes() {
  ...
  const requirements = [
    ...
    [versionInfo.includes('CurrentVersion = "2.1"'), "Gan Browser 2.1 version is missing"],
    [versionInfo.includes('ReleaseName = "Gan Browser 2.1"'), "Gan Browser release name is missing"],
